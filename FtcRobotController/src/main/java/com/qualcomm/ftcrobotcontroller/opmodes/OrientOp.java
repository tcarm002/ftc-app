...
public class OrientOp extends OpMode implements SensorEventListener {
    ...
    */
	...
	public void init() {
		...
		linearAcce = mSensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
...
*/
	...
	public void start() {
		...
		mSensorManager.registerListener(this, linearAcce, SensorManager.SENSOR_DELAY_UI);
	}
...
//        telemetry.addData("4 note3", " " );
		...
		telemetry.addData("y distance", y);
